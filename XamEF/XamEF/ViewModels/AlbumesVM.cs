...
{
    public class AlbumesVM: BaseVM
    {
        #region Services
        private readonly DBAccess<Artista> dataServiceArtistas;
        private readonly DBAccess<Album> dataServiceAlbumes;
        #endregion Services
        ...
        public AlbumesVM()
        {
            this.dataServiceArtistas = new DBAccess<Artista>();
            this.dataServiceAlbumes = new DBAccess<Album>();

            var artistasDB = this.dataServiceArtistas.Get().ToList() as List<Artista>;
            if (artistasDB.Count != 3)
            {
                this.CreateArtistas();
            }
